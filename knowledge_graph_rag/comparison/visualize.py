...
def visualize_graph(
    ...
    net = Network(
        ...
        font_color="white",
        directed=True,
        notebook=False  # Explicitly set to False to avoid template issues
    )
    ...
    # Enable CDN resources to avoid template loading issues
    net.set_options("""
    var options = {
      "physics": {
        "barnesHut": {
    ...
    try:
        ...
        # Fallback: write HTML manually if save_graph doesn't exist
